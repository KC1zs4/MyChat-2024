...
#include "../../Client_new/ChatModel.h"
...
Q_CONSTINIT const QMetaObject ChatModel::staticMetaObject = { {
    QMetaObject::SuperData::link<IChatModel::staticMetaObject>(),
...
void *ChatModel::qt_metacast(const char *_clname)
{
    ...
    return IChatModel::qt_metacast(_clname);
}

int ChatModel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = IChatModel::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
